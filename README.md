...
-t     |[REQUIRED] Specify the file path where the output will be written to. 
...
Additional columns can also be included, and will be copied over to the output file. 
  - ```VSPingCmd.exe -i home/documents/queryimages.txt -o outputinformation.txt -t file -column URL```
...
- Specify the market of the results that you want to search in
...
- Publish the project for your [target OS](https://docs.microsoft.com/en-us/dotnet/core/rid-catalog)
  - For Windows 10 64bit: `dotnet publish -c Release -r windows10-x64`
...
- Build the project with dotnet
   - `dotnet build`
- Publish the project
  - `dotnet publish -c Release -r windows10-x64`
